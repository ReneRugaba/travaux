...
elseif (!empty($_GET) && isset($_GET['action']) && $_GET['action']=='modif' && $_GET['id']){
    ...
    <div class="container-fluid">
       ...
       <form action="service.php?id=<?php echo $data['noserv'];?>&action=edit" method="POST">
                <div class="form-row">
                    <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="noserv" name="noserv" value="<?php echo $data['noserv'];?>">
                    </div>
                    <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="service" name="service" value="<?php echo $data['service'];?>">
                    </div>
                </div>
                <div class="form-group col-md-6">
                <label for="ville">VILLE</label>
                <select id="inputState" class="form-control" name="ville" value="<?php echo $data['ville'];?>">
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
                <table class="table">
                    <thead class="thead-dark">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                            <a href="ajoutserv.php" class="mx-auto d-block"><button type="button" class="btn btn-primary">Ajouter</button></a>
                        </div>
                </div>
            </div>
        </div>
